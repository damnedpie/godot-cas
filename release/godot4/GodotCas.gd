...
func getPossibleConsentFlowStatuses() -> Dictionary:
	if possibleConsentFlowStatuses.is_empty():
...
func getPossibleDebugGeographies() -> Dictionary:
	if possibleDebugGeographies.is_empty():
...
func setUserAppKeywords(keywords:PackedStringArray) -> void:
...
func connectSignals() -> void:
	_cas.connect("initialization_finished", Callable(self, "_onInitializationFinished"))
	_cas.connect("consent_flow_status_changed", Callable(self, "_onConsentFlowStatusChanged"))

	_cas.connect("interstitial_loaded", Callable(self, "_onInterstitialLoaded"))
	_cas.connect("interstitial_failed_to_load", Callable(self, "_onInterstitialFailedToLoad"))
	_cas.connect("interstitial_failed_to_show", Callable(self, "_onInterstitialFailedToShow"))
	_cas.connect("interstitial_showed", Callable(self, "_onInterstitialShowed"))
	_cas.connect("interstitial_clicked", Callable(self, "_onInterstitialClicked"))
	_cas.connect("interstitial_dismissed", Callable(self, "_onInterstitialDismissed"))
	_cas.connect("interstitial_impression", Callable(self, "_onInterstitialImpression"))

	_cas.connect("rewarded_loaded", Callable(self, "_onRewardedLoaded"))
	_cas.connect("rewarded_failed_to_load", Callable(self, "_onRewardedFailedToLoad"))
	_cas.connect("rewarded_failed_to_show", Callable(self, "_onRewardedFailedToShow"))
	_cas.connect("rewarded_showed", Callable(self, "_onRewardedShowed"))
	_cas.connect("rewarded_clicked", Callable(self, "_onRewardedClicked"))
	_cas.connect("rewarded_dismissed", Callable(self, "_onRewardedDismissed"))
	_cas.connect("reward_earned", Callable(self, "_onRewardEarned"))
	_cas.connect("rewarded_impression", Callable(self, "_onRewardedImpression"))

	_cas.connect("banner_loaded", Callable(self, "_onBannerLoaded"))
	_cas.connect("banner_failed", Callable(self, "_onBannerFailed"))
	_cas.connect("banner_clicked", Callable(self, "_onBannerClicked"))
	_cas.connect("banner_presented", Callable(self, "_onBannerPresented"))
	_cas.connect("banner_impression", Callable(self, "_onBannerImpression"))

	_cas.connect("app_open_ad_loaded", Callable(self, "_onAppOpenAdLoaded"))
	_cas.connect("app_open_ad_failed_to_load", Callable(self, "_onAppOpenAdFailedToLoad"))
	_cas.connect("app_open_ad_failed_to_show", Callable(self, "_onAppOpenAdFailedToShow"))
	_cas.connect("app_open_ad_showed", Callable(self, "_onAppOpenAdShowed"))
	_cas.connect("app_open_ad_clicked", Callable(self, "_onAppOpenAdClicked"))
	_cas.connect("app_open_ad_dismissed", Callable(self, "_onAppOpenAdDismissed"))
	_cas.connect("app_open_ad_impression", Callable(self, "_onAppOpenAdImpression"))
